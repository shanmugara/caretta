...
var (
	linksMetrics = promauto.NewGaugeVec(prometheus.GaugeOpts{
		...
		"link_id", "client_id", "client_name", "client_namespace", "client_kind", "client_owner", "client_service_account", "server_id", "server_name", "server_namespace", "server_kind", "server_service_account", "server_port", "role",
	})
...
func (caretta *Caretta) handleLink(link *NetworkLink, throughput uint64) {
	linksMetrics.With(prometheus.Labels{
		...
		"client_service_account": link.Client.ServiceAccount,
		...
		"server_service_account": link.Server.ServiceAccount,
...
func (caretta *Caretta) handleTcpConnection(connection *TcpConnection) {
	tcpStateMetrics.With(prometheus.Labels{
		...
		"client_service_account": connection.Client.ServiceAccount,
		...
		"server_service_account": connection.Server.ServiceAccount,
